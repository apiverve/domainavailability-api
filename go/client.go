// Package domainavailability provides a Go client for the Domain Availability API.
//
// For more information, visit: https://domainavailability.apiverve.com?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/domainavailability"
	defaultTimeout = 30 * time.Second
)

// Client is the Domain Availability API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Domain Availability API client.
...
// Execute makes a request to the Domain Availability API with typed parameters.
//
...
//   - domain (required): string - The domain to check if it is available
