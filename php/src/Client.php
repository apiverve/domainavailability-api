...
namespace APIVerve\Domainavailability;
...
/**
 * Client for the Domain Availability API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://domainavailability.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/domainavailability';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DomainavailabilityClient] {$message}\n";
        }
    }
}
